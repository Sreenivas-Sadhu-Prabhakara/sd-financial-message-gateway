package com.bank.bian.financialmessagegateway.model;
...
/**
 * The BIAN control record for this service domain: "Financial Message Operating Session".
 *
 ...
 * to its asset type (Financial Message). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Message Operating Session";
